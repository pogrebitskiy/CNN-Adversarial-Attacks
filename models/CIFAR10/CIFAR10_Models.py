...
class CIFAR10_FC500_100_10(nn.Module):
    def __init__(self, num_classes=10):
        super(CIFAR10_FC500_100_10, self).__init__()
        self.fc1 = nn.Linear(3 * 32 * 32, 500)  # Adjust the input size to match CIFAR-10 images
